                ...
                <div class="clearfix">
                    ...
                    <div class="weChat_account_left">
                        ...
                        <p class="account_qr_code">
                            <?php if(!empty($goods['code'])): ?><a href="javascript:void(0);" onclick="show_code('<?php echo ($goods["code"]); ?>')"><img src="<?php echo ($goods["code"]); ?>"></a><?php endif; ?>
                        </p>
                    </div>
                    <!-- 头像 end-->
                    ...
                    <div class="account_info_box">
                        ...
                        <div class="weChat_account_data color_light">
                            <ul class="clearfix">
                                <li class="text_left">
                                    <img src="/Application/Home/Public/images/fans_identified.png" width="18" style="display: none" class="account_others_fans_identified">账号提供粉丝数<em><?php echo ($goods["fans"]); ?>万</em>
                                </li>
                                <li class="text_center"><?php if($goods['typeid'] == 3): ?>平均播放量<?php else: ?>预估有效阅读人数<?php endif; ?><em><?php echo ($goods["reading"]); ?></em>
                        ...
                        <table width="100%" class="weChat_priceData">
                            <tbody><tr>
                                <th width="44%">位置</th>
                                <th width="38%">参考报价</th>
                                <th width="18%">平均阅读量</th>
                            </tr>
                            <?php if(is_array($specprice)): foreach($specprice as $key=>$v): ?><tr>
                                    <td>
                                        <span><?php echo ($goodsspec[$v['specid']]['specname']); ?></span>
                                    </td>
                                    <td>
                                        <b class="color_high_light money">￥<?php echo ($v["price"]); ?></b>
                                    </td>
                    ...
                    <div class="weChat_profile">
                        <table>
                            <tbody><tr>
                                <th>功能简介</th>
                                <td><?php echo ($goods["instro"]); ?></td>
                            </tr>
                            <tr>
                                <th>认证信息</th>
                                <td><?php echo ($goods["certify"]); ?></td>
                            </tr>
                            <tr>
                                <th>近30天被选次数</th>
                                <td><span><?php echo ($goods['monthorder']); ?></span>次</td>
                            </tr>
                            <tr>
                        ...
                        <span class="snbt_data_num">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <?php if(is_array($goods['catid'])): foreach($goods['catid'] as $key=>$t): ?><span><?php echo ($t); ?>&nbsp;</span><?php endforeach; endif; ?>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <th>图文热词</th>
                                <td id="js_keyword_notes" style="position: relative"><img src="<?php echo ($goods["keyimg"]); ?>" style="display: block;position: absolute" /></td>
                            </tr>
                            </tbody></table>
                    </div>
