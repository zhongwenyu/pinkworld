    ...
    <div class="content clearfix">
        ...
        <div class="nav_bottom">
            <div class="content">
                <ul>
                    <li>
                        <a class="font_size_xxlarge nav_bottom_current" href="<?php echo U('Home/Goods/goodslist',array('typeid'=>1));?>">
                            全部公众号</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Home/Goods/goodslist',array('typeid'=>1));?>">
                            <img src="/Application/Home/Public/images/nav_voice_2x.png">
                            大V自媒体</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Home/Goods/goodslist',array('typeid'=>1));?>">
                            <img src="/Application/Home/Public/images/nav_crown_2x.png">
                            白领丽人精选</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Home/Goods/goodslist',array('typeid'=>1));?>">
                            <img src="/Application/Home/Public/images/nav_hot_2x.png">
                            热门账号</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Home/Goods/goodslist',array('typeid'=>1));?>">
                            <img src="/Application/Home/Public/images/nav_fresh_2x.png">
                            新鲜上架</a>
                    </li>
                </ul>
            </div>
        ...
        <div id="filterItemsContainer">
                ...
                <div class="searchWrap clearfix">
                    <div class="searchContainer">
                        <div class="search_inputWrap">
                            ...
                            <input type="text" class="search_input" id="search_input" placeholder="请输入微信号、关键字"></div>
                        <a href="javascript:void(0);" onclick="show_goodslist(1,'keyword','weixin',this)" class="search_button">搜微信公众号</a>
                    </div>
                </div>
                                ...
                                <div class="categoryContent relative">
                                    <div class="categoryContent_list" id="morecat">
                                        <ul class="common_category_container clearfix miaopai_filter">
                                            <li>
                                                <a href="javascript:void(0);" onclick="show_goodslist(1,'','',this)" <?php if(empty($catid)): ?>class="current"<?php endif; ?>>不限</a>
                                            </li>
                                            <?php if(is_array($cat)): foreach($cat as $key=>$v): ?><li><a href="/weixin/catid/<?php echo ($v['id']); ?>" <?php if($catid == $v['id']): ?>class="current"<?php endif; ?>><?php echo ($v["catname"]); ?></a></li><?php endforeach; endif; ?>
                                        </ul>
                                ...
                                <div class="categoryContent clearfix">
                                    <div class="">
                                        <ul data-bind="foreach: items" class="price_wrap">
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'','',this)" class="current">不限</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'fans','0-1',this)">1万以下</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'fans','1-5',this)">1-5万</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'fans','5-10',this)">5-10万</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'fans','10-50',this)">10-50万</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'fans','50-100',this)">50-100万</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'fans','以上',this)">100万以上</a></li>
                                        </ul>
                                    </div>
                                    <p class="fr">
                                        ...
                                        <span class="button btn_small_important" onclick="show_goodslist(1,'ckprice','price1','price2','between')"><span class="btn_wrap">确定</span></span>
                                    </p>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td>
                                <div class="categoryContent clearfix">
                                    <div class="fl">
                                        <ul data-bind="foreach: items" class="price_wrap">
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'','',this)" class="current">不限</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'ckprice','0-100',this)">100元以下</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'ckprice','100-200',this)">100-200元</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'ckprice','200-1000',this)">200-1000元</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'ckprice','1000-5000',this)">1000-5000元</a></li>
                                            <li><a href="javascript:void(0);" onclick="show_goodslist(1,'ckprice','以上',this)">5000元以上</a></li>
                                        </ul>
                                    </div>
                                    <p class="fr">
                                        <span class="price_range_wrap">
                                        ...
                                        <span class="button btn_small_important" onclick="show_goodslist(1,'fans','fans1','fans2','between')"><span class="btn_wrap">确定</span></span>
                                    </p>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="list_box_filter font_size_small content">
                <div class="">
                    <label class="fl choseAll_label" onclick="all_cart(this,1)">
                        <input  type="checkbox">
                ...
                共计<span id="accountTotal"><?php echo ($count); ?></span>个
                    ...
                    <div class="list_filter_content">
                        <label>
                            <input type="checkbox" onclick="checkbox_goodslist(1,'isrz',this)">
                            <span>微信认证</span>
                        </label>
                        <label>
                            <input type="checkbox" onclick="checkbox_goodslist(1,'sign',this,2)">
                            <span>原创撰稿</span>
                        </label>
                        <label>
                            <input type="checkbox">
                        ...
                        <div class="executeType">
                            ...
                            <span class="">
                                <a href="javascript:void(0);" onclick="show_goodslist(1,'','',this,'color_high_light')" class="color_high_light">不限</a>
                                <a href="javascript:void(0);" onclick="show_goodslist(1,'isyy','1',this,'color_high_light')">需预约</a>
                                <a href="javascript:void(0);" onclick="show_goodslist(1,'isyy','0',this,'color_high_light')">无需预约</a>
                            </span>
                        </div>
                        <div class="list_filter_category">
                            <a class="color_default" href="javascript:void(0)" onclick="show_goodslist(1,'order','firstreading',this)">多图文第一条阅读量</a>
                        </div>
                        <div class="list_filter_category list_sort_box">
                            ...
                            <ul class="list_sort_content" style="display: none;">
                                <li data-bind="">
                                    <a href="javascript:void(0);" onclick="show_goodslist(1,'order','ckprice',this)">
                                        <span>价格从低到高</span>
                                    </a>
                                    <a href="javascript:void(0);" onclick="show_goodslist(1,'order','reading',this)">
                                        <span>阅读量从高到低</span>
                                    </a>
                                </li>
                            </ul>
