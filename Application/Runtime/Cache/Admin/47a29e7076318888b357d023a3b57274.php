...
<div class="mod-box">
    ...
    <div class="mod-search form-group">
        <form id="search-form1" action="" method="post" onsubmit="return false">
            <label for="key_word" class="fl mhg">名称</label>
            <input type="text" class="msea fl mr18 form-control mhg" name="key_word" id="key_word" placeholder="请输入名称" />
            ...
            <a href="<?php echo U('Admin/Goods/add_live',array('typeid'=>3,'act'=>'add'));?>" class="fr btn btn-primary ma"><span class="glyphicon glyphicon-plus glyadd"></span>新增视频</a>
        </form>
    </div>
    <div class="mod-table">
            ...
            <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr>
                    ...
                    <td class="center">
                        <?php if($v['sex'] == 0): ?>无
                            ...
                            <?php elseif($v['sex'] == 2): ?>女<?php endif; ?>
                    </td>
                    <td class="center">
                        <?php if($v['isrz']): ?>是
                    ...
                    <td class="center"><?php echo ($v["liked"]); ?></td>
                    ...
                    <td>
                        <a href="<?php echo U('Admin/Goods/add_live',array('act'=>'edit','typeid'=>$v['typeid'],'id'=>$v['id']));?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil pr3"></span>编辑</a>
