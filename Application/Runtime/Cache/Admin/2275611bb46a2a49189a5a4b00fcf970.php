...
<div id="lgbg">
    <div class="id-login">
        ...
        <div class="input-group input-group-lg idiput ml40 mb10">
            ...
            <span class="input-group-addon verity"><img src="<?php echo U('Admin/verify');?>" id="verify_repeat" /></span>
        </div>
...
<script>
    ...
    $("#verify_repeat").click(function(){
        $("#verify_repeat").attr("src","<?php echo U('Admin/verify');?>"+"/"+Math.floor(Math.random()*100));
    });
</script>
</body>
</html>