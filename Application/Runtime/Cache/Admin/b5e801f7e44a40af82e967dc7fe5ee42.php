...
<div class="mod-box">
    ...
    <div class="mod-search form-group">
        <form id="search-form1" action="" method="post" onsubmit="return false">
            <label for="key_word" class="fl mhg">微博名</label>
            <input type="text" class="msea fl mr18 form-control mhg" name="key_word" id="key_word" placeholder="请输入微博名" />
            ...
            <a href="<?php echo U('Admin/Goods/add_weibo',array('act'=>'add','typeid'=>2));?>" class="fr btn btn-primary ma"><span class="glyphicon glyphicon-plus glyadd"></span>新增微博</a>
        </form>
    </div>
    <div class="mod-table">
        <table cellspacing="0" class="table table-striped table-bordered ">
            ...
            <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr>
                    ...
                    <td>
                        <a href="<?php echo U('Admin/Goods/add_weibo',array('act'=>'edit','typeid'=>$v['typeid'],'id'=>$v['id']));?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil pr3"></span>编辑</a>
