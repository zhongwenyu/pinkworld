...
<div class="mod-box">
    <div class="mod-title">
        <h5>
            <?php if($action == 'add'): ?>新增微信公众号
                <?php else: ?>编辑微信公众号<?php endif; ?>
        </h5>
    </div>
    <div class="mod-form pb50">
        <form action="" method="post" id="form1">
            <div class="mform-box form-group">
                <label for="name" class="mform-lab">微信名：</label>
                <input type="text" class="form-control mform-inp1" name="name" id="name" value="<?php echo ($goods["name"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="wechat" class="mform-lab">微信号：</label>
                <input type="text" class="form-control mform-inp1" name="wechat" id="wechat" value="<?php echo ($goods["wechat"]); ?>" />
            </div>
            <div class="mform-box form-group">
            ...
            <div class="mform-box form-group">
                ...
                <div class="mform-addnew">
                    <?php if(empty($goods)): if(is_array($goodsspec)): foreach($goodsspec as $key=>$v): ?><div class="mfad-mod">
                                <input type="checkbox" name="spec[]" id="gho<?php echo ($v["id"]); ?>" value="<?php echo ($v["id"]); ?>" class="form-check form-cbox2" onclick="inp_check(this,1)" />
                        ...
                        <?php if(is_array($goodsspec)): foreach($goodsspec as $key=>$v): ?><div class="mfad-mod">
                                <input type="checkbox" name="spec[]" id="gho<?php echo ($v["id"]); ?>" value="<?php echo ($v["id"]); ?>" class="form-check form-cbox2" onclick="inp_check(this,1)" <?php if($specprice[$v['id']]): ?>checked<?php endif; ?> />
                                <label for="gho<?php echo ($v["id"]); ?>" class="btn btn-default"><?php echo ($v["specname"]); ?></label>
                                <?php if($specprice[$v['id']]): ?><input type="text" name="readings[]" value="<?php echo ($specprice[$v['id']]['reading']); ?>" class="form-control mform-inp2 mr10" placeholder="阅读量">
                                    <input type="text" name="price[]" value="<?php echo ($specprice[$v['id']]['price']); ?>" class="form-control mform-inp2 mr10" placeholder="报价"><?php endif; ?>
            ...
            <div class="mform-box form-group">
                <label for="reading" class="mform-lab">阅读量：</label>
            ...
            <div class="mform-box form-group">
                <label for="code" class="mform-lab">微信二维码：</label>
                <input type="text" class="form-control mform-inp1 original_img2" name="code" id="code" value="<?php echo ($goods["code"]); ?>" />
                <a href="javascript:void(0)" onclick="GetUploadify('weixin','frm2','1','4MB','call_back','original_img2')" class="btn btn-default mod-btn">上传</a>
                <a href="javascript:void(0)" onclick="del_upimg('original_img2',this)" class="btn btn-default mod-btn del-img">删除</a>
                <div class="form-view">
                    <?php if(empty($goods)): ?><img src="/Application/Admin/Public/images/pic-moren.jpg" class="original_img1" />
                        <?php else: ?>
                        <img src="<?php echo ($goods["code"]); ?>" class="original_img1" /><?php endif; ?>
                </div>
            </div>
            <div class="mform-box form-group">
                <label class="mform-lab">是否微信认证：</label>
            ...
            <div class="mform-box">
                ...
                <input type="button" onclick="ajax_add('form1','<?php echo U('Admin/Goods/add_weixin');?>')" class="btn btn-primary mform-sub" value="保存" />
            </div>
        </form>
    </div>
</div>
