...
<script>document.write("<script type='text/javascript' "+ "src='/Public/plugins/uploadify/jquery.uploadify.min.js?" + new Date()+ "'></s" + "cript>");
</script>			
...
$("#SaveBtn").click(function(){	
	...
	var classname = "<?php echo ($info["classname"]); ?>";
	...
	if(callback != "undefined"){	
		...
		eval('window.parent.'+callback+'(fileurl_tmp,classname)');
