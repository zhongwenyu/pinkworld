...
<div class="mod-box">
    <div class="mod-title">
        <h5>
            <?php if($action == 'add'): ?>新增视频直播
                <?php else: ?>编辑视频直播<?php endif; ?>
        </h5>
    </div>
    <div class="mod-form pb50">
        <form action="" method="post" id="form1">
            <div class="mform-box form-group">
                <label for="name" class="mform-lab">名称：</label>
            ...
            <div class="mform-box form-group">
                <label for="keytitle" class="mform-lab">视频链接：</label>
            ...
            <div class="mform-box form-group">
                <label class="mform-lab">平台分类：</label>
                <div class="mform-addnew">
                    <?php if(is_array($platcat)): foreach($platcat as $key=>$v): ?><input type="checkbox" name="platcat[]" id="platcat<?php echo ($v["id"]); ?>" value="<?php echo ($v["id"]); ?>" class="form-check form-cbox3" <?php if(!empty($goods)): if(in_array(($v['id']), is_array($goods['platcatid'])?$goods['platcatid']:explode(',',$goods['platcatid']))): ?>checked<?php endif; endif; ?> />
                        <label for="platcat<?php echo ($v["id"]); ?>" class="btn btn-default"><?php echo ($v["catname"]); ?></label><?php endforeach; endif; ?>
                </div>
            </div>
            <div class="mform-box form-group">
                <label for="area" class="mform-lab">地区：</label>
                <input type="text" class="form-control mform-inp1" name="area" id="area" value="<?php echo ($goods["area"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="liked" class="mform-lab">点赞数：</label>
                <input type="text" class="form-control mform-inp1" name="liked" id="liked" value="<?php echo ($goods["liked"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="comment" class="mform-lab">评论数：</label>
                <input type="text" class="form-control mform-inp1" name="comment" id="comment" value="<?php echo ($goods["comment"]); ?>" />
            </div>
            <div class="mform-box form-group">
            ...
            <div class="mform-box form-group">
                <label for="age" class="mform-lab">年龄：</label>
                <input type="text" class="form-control mform-inp1" name="age" id="age" value="<?php echo ($goods["age"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="pjgz" class="mform-lab">平均直播观众数：</label>
                <input type="text" class="form-control mform-inp1" name="pjgz" id="pjgz" value="<?php echo ($goods["pjgz"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="zggz" class="mform-lab">最高直播观众数：</label>
                <input type="text" class="form-control mform-inp1" name="zggz" id="zggz" value="<?php echo ($goods["zggz"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="reward" class="mform-lab">收到的打赏数：</label>
                <input type="text" class="form-control mform-inp1" name="reward" id="reward" value="<?php echo ($goods["reward"]); ?>" />
            </div>
            <div class="mform-box form-group">
                <label for="reading" class="mform-lab">播放数：</label>
                <input type="text" class="form-control mform-inp1" name="reading" id="reading" value="<?php echo ($goods["reading"]); ?>" />
            </div>
            <div class="mform-box form-group">
            ...
            <div class="mform-box form-group">
                ...
                <input type="radio" name="isshow" id="noshow" class="form-check form-cbox1" value="0" <?php if(!empty($catdetail)): if($goods['isshow'] == 0): ?>checked<?php endif; endif; ?> />
            ...
            <div class="mform-box">
                ...
                <input type="button" onclick="ajax_add('form1','<?php echo U('Admin/Goods/add_live');?>')" class="btn btn-primary mform-sub" value="保存" />
            </div>
        </form>
    </div>
</div>
